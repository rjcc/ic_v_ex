...
graph export km_`e'_`grp'.jpg, replace quality(100) width(1600) height(1200)
end
...
* Grouping setting 6: FLUSH6: Extracellular EX (CELSIOR & HTK & DELNIDO) vs. Intracellular IC (UW)
